...
const RangersSecretPage = () => {
  return (
    <React.Fragment>
      <h3>This is the Secret Ranger page!</h3>
      <p>It is located at src/pages/RangerSecretPage/RangerSecretPage.jsx</p>
...
export default RangersSecretPage;

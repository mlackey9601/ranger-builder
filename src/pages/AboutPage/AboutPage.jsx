    ...
    <div className="AboutPage">
        ...
        <div className="about-container">
          ...
          <div className="article">
            <p className="about-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b className="W">W</b>hen I first began playing <b><i>Rangers of Shadow Deep</i></b>, I found myself immersed in a world that Joseph McCullough had created, but also one that he'd allowed me to <i>participate in</i>.  To me, that's what makes playing his games so fun.  He truly sets you up to be a co-creator.<br></br>
